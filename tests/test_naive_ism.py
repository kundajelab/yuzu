...
"""
Testing the naive ISM implementation using the built-in models. These are
regression tests. 
"""
...
def test_one_layer():
	...
	isms = naive_ism(model, X)
	assert_array_almost_equal(isms, one_layer_ism_scores, 4)
...
def test_toynet():
	...
	isms = naive_ism(model, X)
	assert_array_almost_equal(isms, toynet_ism_scores, 4)
...
def test_deepsea():
	...
	isms = naive_ism(model, X)
	assert_array_almost_equal(isms, deepsea_ism_scores, 4)
...
def test_basset():
	...
	isms = naive_ism(model, X)
	print(list(numpy.around(isms, 4)))
	assert_array_almost_equal(isms, basset_ism_scores, 4)
...
def test_bpnet():
	...
	isms = naive_ism(model, X)
	assert_array_almost_equal(isms, bpnet_ism_scores, 4)
